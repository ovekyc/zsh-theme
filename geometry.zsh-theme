# newline-geometry
# Based on Geometry and Avit and Pure
...
GEOMETRY_COLOR_GIT_BRANCH=${GEOMETRY_COLOR_GIT_BRANCH:-magenta}
...
# Symbol definitions
GEOMETRY_SYMBOL_NEWLINE=${GEOMETRY_SYMBOL_PROMPT:-"\n"}
